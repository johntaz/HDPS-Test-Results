/*==============================================================================
FILE NAME:				an_002_hdps_test_requested
AUTHOR:					John Tazare
DESCRIPTION OF FILE:	Run test-requested HDPS analysis 
*=============================================================================*/
...
* Results
tempname john 
postfile `john' str30(outcome) str20(bias) float(no_of_vars hr ll ul) using "$projectdir/data/testResults_hdps_test_request", replace 
...
keep if dim == "d1" | dim == "d2" | dim == "d3" | dim == "d4" // d4 = test-requested dimension
gen pc1=e1c1/e1
gen pc0=e0c1/e0
gen rr_ce=pc1/pc0
...
save "$projectdir/data/pscores/pscores_test_request_`no_overall'.dta", replace
