...
AUTHOR:					John Tazare
DESCRIPTION OF FILE:	Run test-requested + test cut-offs
						 HDPS analysis 
*=============================================================================*/
...
* Results
tempname john 
postfile `john' str30(outcome) str20(bias) float(no_of_vars hr ll ul) using "$projectdir/data/testResults_hdps_cut_offs", replace 
...
save "$projectdir/data/pscores/pscores_cut_offs_`no_overall'.dta", replace
